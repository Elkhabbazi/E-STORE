...
$categoriesFemmes = ['Caftan', 'Takchita', 'Jellaba Femme'];

// Construction de la requête avec filtres
$where  = ["category IN ('Caftan', 'Takchita', 'Jellaba Femme')", "stock > 0"];
$params = [];
...
<div class="page-header">
  ...
  <div class="page-header-inner">
    ...
    <p class="page-sub">Caftan · Takchita · Jellaba Femme</p>
  </div>
</div>
    ...
    <div class="products-grid">
      <?php if (empty($products)): ?>
        <div class="empty">
          ...
          <a href="femmes.php" style="display:inline-block;margin-top:1rem;font-size:0.65rem;letter-spacing:0.15em;text-transform:uppercase;color:var(--gold);">
